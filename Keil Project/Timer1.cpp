...
void Timer1_Init(void(*task)(void), uint32_t period){
  ...
  TIMER1_CTL_R = 0x0;    // 1) disable TIMER1A during setup
  TIMER1_CFG_R = 0x0;    // 2) configure for 32-bit mode
  TIMER1_TAMR_R = 0x2;   // 3) configure for periodic mode, default down-count settings
